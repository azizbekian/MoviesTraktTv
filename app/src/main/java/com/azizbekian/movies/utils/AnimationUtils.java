...
public class AnimationUtils {
     ...
     * If Android SDK is higher than API 21 - circular reveal animation would be show.
     * Otherwise - an ordinary fade in/out animation would be shown.
     *
     ...
     * @param open If true - indicates, that circular reveal/fade in anim would be show.
     *             If false - circular hide/fade out anim would be shown.
    ...
    private static Animator createRevealAnim(final View view, int x, int y) {

        float finalRadius = (float) Math.hypot(view.getMeasuredWidth(), view.getMeasuredHeight());
    ...
    private static Animator createFadeAnim(final View view, final boolean fadeIn) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                view.setVisibility(fadeIn ? View.VISIBLE : View.INVISIBLE);
            }
        });
